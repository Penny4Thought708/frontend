...
/* -------------------------------------------------------
   CALL CONTROLS ENGINE
   Handles: inbound, active, dropdown, icons, UI state
------------------------------------------------------- */

const callWindow = document.getElementById("videoCallWindow");
...
const btnDecline = document.getElementById("decline-call");
const btnAnswer = document.getElementById("answer-call");
const btnEnd = document.getElementById("end-call");
const btnMute = document.getElementById("mute-call");
const btnCamera = document.getElementById("camera-toggle");
const btnShare = document.getElementById("share-screen");
const btnNoise = document.getElementById("ai-noise-toggle");
const btnRecord = document.getElementById("record-call");

/* -------------------------------------------------------
   STATE MACHINE
------------------------------------------------------- */

export function setCallUIState(state) {
  // Remove all modes
  callWindow.classList.remove("inbound-mode", "active-mode");

  switch (state) {
    case "inbound":
      callWindow.classList.add("inbound-mode");
      break;

    case "active":
      callWindow.classList.add("active-mode");
      break;
  }
}
...
if (btnMute) {
  btnMute.addEventListener("click", () => {
    ...
    btnMute.innerHTML = track.enabled
...
if (btnCamera) {
  btnCamera.addEventListener("click", () => {
    ...
    btnCamera.classList.toggle("flipped");

    btnCamera.innerHTML = track.enabled
...
/* -------------------------------------------------------
   NOISE SUPPRESSION TOGGLE (UI ONLY)
------------------------------------------------------- */

if (btnNoise) {
  btnNoise.addEventListener("click", () => {
    btnNoise.classList.toggle("active");
  });
}

/* -------------------------------------------------------
   RECORD BUTTON (UI ONLY)
------------------------------------------------------- */
